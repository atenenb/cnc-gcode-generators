...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        st2 = Label(self, text='Final Diameter ')
    ...
    def load_preferences(self):
        self.nc_dir = self.get_ini_data('turn_od.ini', 'Directories', 'NcFiles', os.path.expanduser("~"))
        self.feedrate_var.set(self.get_ini_data('turn_od.ini', 'LathePara', 'Feedrate', '1000'))
        self.depth_of_cat_var.set(self.get_ini_data('turn_od.ini', 'LathePara', 'DepthOfCut', '3'))
        self.spindle_rpm_var.set(self.get_ini_data('turn_od.ini', 'LathePara', 'SpindleRPM', '9000'))
        self.unit_var.set(int(self.get_ini_data('turn_od.ini', 'LathePara', 'UnitVar', '2')))
        self.home_var.set(int(self.get_ini_data('turn_od.ini', 'LathePara', 'HomeVar', '4')))
        self.safe_var.set(self.get_ini_data('turn_od.ini', 'LathePara', 'SafeZ', '10.0'))
        self.blank_od_var.set(self.get_ini_data('turn_od.ini', 'Part', 'X0'))
        self.final_od_var.set(self.get_ini_data('turn_od.ini', 'Part', 'X1'))
        self.depth_of_final_cut_var.set(self.get_ini_data('turn_od.ini', 'LathePara', 'DepthOfFinalCut'))
        self.start_z_var.set(self.get_ini_data('turn_od.ini', 'LathePara', 'StartZ'))
        self.end_z_var.set(self.get_ini_data('turn_od.ini', 'LathePara', 'EndZ'))
    ...
    def save_preferences(self):
        ...
        self.cp = ConfigParser()
        fn = open('turn_od.ini', 'w')
        set_pref('Directories', 'NcFiles', self.nc_dir)
        set_pref('LathePara', 'Feedrate', self.feedrate_var.get())
        set_pref('LathePara', 'DepthOfCut', self.depth_of_cat_var.get())
        set_pref('LathePara', 'SpindleRPM', self.spindle_rpm_var.get())
        set_pref('LathePara', 'UnitVar', self.unit_var.get())
        set_pref('LathePara', 'HomeVar', self.home_var.get())
        set_pref('LathePara', 'SafeZ', self.safe_var.get())
        set_pref('LathePara', 'StartZ', self.start_z_var.get())
        set_pref('LathePara', 'EndZ', self.end_z_var.get())
        set_pref('LathePara', 'DepthOfFinalCut', self.depth_of_final_cut_var.get())
